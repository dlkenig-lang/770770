...
const QC_STAGES = [
  {
    ...
    items: [
      { key: 'length_dims', label: 'מידות אורך', instruction: null },
      { key: 'width_dims', label: 'מידות רוחב', instruction: null },
      { key: 'pipe_slope', label: 'שיפוע צינור 1.5%', instruction: 'ודא שיפוע של 1.5% לפחות' },
      { key: 'pipe_fixation', label: 'קיבוע צינור', instruction: null },
      { key: 'drainage_channel', label: 'תעלת ניקוז', instruction: null },
