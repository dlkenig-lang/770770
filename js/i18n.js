...
const I18N = {
  he: {
    ...
    'proj.targetScrapped': 'נפסלו',
    'proj.targetRemaining': 'נשארו לבצע',
    'proj.targetTotal': 'סה"כ',
    'proj.targetOverTitle': 'הוזנו יותר יחידות מכמות היעד',
    'pod.scrapped': 'נפסל',
    'pod.scrappedBadge': '✖ נפסל',
    'pod.scrappedTitle': 'פוד פסול — אינו נספר בכמות היעד',
    'pod.scrapAction': '✖ סמן כפסול',
    'pod.unscrapAction': '↩ בטל פסילה',
    'pod.scrapTitle': 'פסילת יחידה {code}',
    'pod.scrapExplain': 'היחידה תסומן כפסולה: היא לא תיספר בכמות היעד של הפרויקט ולא תוצע לשיוך יעד משלוח. היא אינה נמחקת — היסטוריית הבדיקות נשמרת והפעולה מתועדת ביומן השינויים.',
    'pod.scrapReason': 'סיבת הפסילה',
    'pod.scrapReasonPh': 'למשל: סדק ברצפת הבטון לאחר יציקה',
    'pod.scrapNeedReason': 'חובה לציין סיבת פסילה',
    'pod.scrapConfirm': 'פסול יחידה',
    'pod.scrapDone': 'היחידה סומנה כפסולה',
    'pod.unscrapConfirm': 'לבטל את הפסילה של {code}? היחידה תחזור להיספר בכמות היעד.',
    'pod.unscrapDone': 'הפסילה בוטלה',
    'pod.scrapError': 'שגיאה בעדכון הפסילה: ',
    'audit.pod_scrapped': 'היחידה נפסלה',
    'audit.pod_unscrapped': 'הפסילה בוטלה',
