...
const I18N = {
  he: {
    ...
    'common.close': 'סגור',
    'common.delete': 'מחק',
    'auth.togglePassword': 'הצג/הסתר סיסמה',
    ...
    'audit.stage_cleared': 'טופס שלב נוקה',
    'audit.stage_updated': 'סטטוס שלב עודכן',
    'audit.mold_signed': 'בדיקת תבנית נחתמה',
    ...
    'tabs.plans': 'תוכניות',
    'tabs.molds': 'בדיקות תבניות',

    // Mold checks (בדיקות תבניות)
    'mold.add': '+ בדיקת תבנית',
    'mold.none': 'אין עדיין בדיקות תבניות בפרויקט',
    'mold.newTitle': 'בדיקת תבנית חדשה',
    'mold.moldLabel': 'תבנית',
    'mold.moldNumber': 'מספר תבנית',
    'mold.noDirection': 'ללא כיוון',
    'mold.createBtn': 'צור בדיקה',
    'mold.enterNumber': 'יש להזין מספר תבנית תקין',
    'mold.created': 'בדיקת התבנית נוצרה',
    'mold.confirmDelete': 'האם למחוק בדיקת תבנית זו? הנתונים שהוזנו בה יימחקו.',
    'mold.deleted': 'בדיקת התבנית נמחקה',
    'mold.saved': 'הבדיקה נשמרה',
    'mold.signFinish': 'חתום וסיים',
    'mold.reopen': 'פתח מחדש לעריכה',
    'mold.finishedOk': 'בדיקת התבנית הושלמה ואושרה',
    'mold.finishedFailed': 'בדיקת התבנית נחתמה עם סעיפים שנכשלו',
    'mold.itemsAnswered': 'סעיפים שמולאו',
    'mold.measuredValue': 'ערך נמדד',
    'mold.item.length': 'מידות אורך',
    'mold.item.width': 'מידות רוחב',
    'mold.item.concrete_height': 'גובה בטון',
    'mold.item.belt_height': 'גובה חגורה',
    'mold.item.door_opening': 'מידת פתח הדלת',
    'mold.item.elec_cabinet': 'ארון חשמל',
    'mold.item.drainage_channel': 'תעלת ניקוז',
    'mold.item.lifting_bolts': 'עיגון ברגי הרמה',
    'mold.item.shower_parallel': 'מקבילות אגנית מקלחון',
    'mold.instr.length': 'סטיה תקינה של ± 2 מ"מ',
    'mold.instr.width': 'סטיה תקינה של ± 2 מ"מ',
    ...
    'filter.allStages': 'כל השלבים',
    'filter.stageOpt': 'שלב {letter} – {name}',
    ...
    'qc.signMissingItems': 'שים לב: {n} סעיפים טרם סומנו:\n{items}\n\nהאם לחתום על השלב בכל זאת?',
    'qc.fixedAt': 'תוקן בתאריך {date}',
    'pod.inspectionStarted': 'תחילת בדיקה',
    'qc.itemSaveError': 'שמירת הסימון נכשלה והוא לא נקלט — בדקו את החיבור ונסו שוב',
    ...
    'qc.castingClearedOnSign': 'שלב A נחתם — הפוד הוסר מרשימת מאושרי ליציקה',
    ...
    'proj.stageBadge': 'שלב {letter}: {status}',
    'proj.noPodsInStage': 'אין פודים בשלב הנבחר',
    'proj.noPanelsInStage': 'אין פאנלים בשלב הנבחר',
    ...
    'proj.errNeedNumberMigration': 'חסרה עמודת project_number במסד הנתונים. יש להריץ את המיגרציה 20260803010000_project_number.sql ב-Supabase SQL Editor לפני יצירת פרויקט חדש.',
    ...
    'proj.confirmDeleteGroup': 'האם למחוק קבוצה זו? הפודים שבקבוצה לא יימחקו — הם רק ינותקו מהקבוצה.',
    'proj.groupDeleted': 'הקבוצה נמחקה והפודים שלה נותקו ממנה',
    ...
    'auth.registerSuccess': 'נרשמת בהצלחה! החשבון ממתין לאישור מנהל המערכת — תקבל גישה לאחר האישור.',
    'auth.pendingApproval': 'החשבון שלך ממתין לאישור מנהל המערכת. נסה להתחבר שוב לאחר שהחשבון יאושר.',
  ...
  en: {
    ...
    'audit.stage_cleared': 'Stage form cleared',
    'audit.stage_updated': 'Stage status updated',
    'audit.mold_signed': 'Mold check signed',
    ...
    'tabs.plans': 'Plans',
    'tabs.molds': 'Mold Checks',

    // Mold checks
    'mold.add': '+ Mold Check',
    'mold.none': 'No mold checks in this project yet',
    'mold.newTitle': 'New Mold Check',
    'mold.moldLabel': 'Mold',
    'mold.moldNumber': 'Mold number',
    'mold.noDirection': 'No direction',
    'mold.createBtn': 'Create check',
    'mold.enterNumber': 'Please enter a valid mold number',
    'mold.created': 'Mold check created',
    'mold.confirmDelete': 'Delete this mold check? All data entered in it will be lost.',
    'mold.deleted': 'Mold check deleted',
    'mold.saved': 'Check saved',
    'mold.signFinish': 'Sign & Finish',
    'mold.reopen': 'Reopen for editing',
    'mold.finishedOk': 'Mold check completed and approved',
    'mold.finishedFailed': 'Mold check signed with failed items',
    'mold.itemsAnswered': 'Items answered',
    'mold.measuredValue': 'Measured value',
    'mold.item.length': 'Length dimensions',
    'mold.item.width': 'Width dimensions',
    'mold.item.concrete_height': 'Concrete height',
    'mold.item.belt_height': 'Belt height',
    'mold.item.door_opening': 'Door-opening dimension',
    'mold.item.elec_cabinet': 'Electrical cabinet',
    'mold.item.drainage_channel': 'Drainage channel',
    'mold.item.lifting_bolts': 'Lifting-bolt anchoring',
    'mold.item.shower_parallel': 'Shower-tray parallelism',
    'mold.instr.length': 'Acceptable tolerance of ± 2 mm',
    'mold.instr.width': 'Acceptable tolerance of ± 2 mm',
    ...
    'filter.stageOpt': 'Stage {letter} – {name}',
    ...
    'qc.signMissingItems': 'Note: {n} items are not marked yet:\n{items}\n\nSign the stage anyway?',
    'qc.fixedAt': 'Fixed on {date}',
    'pod.inspectionStarted': 'Inspection started',
    'qc.itemSaveError': 'Saving the mark failed — it was not recorded. Check your connection and try again.',
    ...
    'qc.castingClearedOnSign': 'Stage A signed — the pod was removed from the casting-approved list',
    ...
    'proj.stageBadge': 'Stage {letter}: {status}',
    'proj.noPodsInStage': 'No pods in the selected stage',
    'proj.noPanelsInStage': 'No panels in the selected stage',
    ...
    'proj.errNeedNumberMigration': 'The project_number column is missing from the database. Run migration 20260803010000_project_number.sql in the Supabase SQL Editor before creating a new project.',
    ...
    'proj.confirmDeleteGroup': 'Delete this group? Its pods will not be deleted — they will only be detached from the group.',
    'proj.groupDeleted': 'Group deleted and its pods detached',
    'proj.addPod': 'Add pod',
    ...
    'auth.registerSuccess': 'Registered successfully! Your account is pending admin approval — you will get access once approved.',
    'auth.pendingApproval': 'Your account is pending admin approval. Please try signing in again after it has been approved.',
